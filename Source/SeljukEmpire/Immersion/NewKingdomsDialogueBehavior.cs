...
namespace SeljukEmpire.Immersion
{
    ...
    /// SeljukDialogueBehavior/RivalCultureDialogueBehavior - see GreetingVariety's remarks
    ...
    public class NewKingdomsDialogueBehavior : CampaignBehaviorBase
    {
        ...
        private void OnSessionLaunched(CampaignGameStarter starter)
        {
            try
            {
                ...
                starter.AddDialogLine("crus_bohemond_greeting_1", "start", "lord_start",
                    ...
                    () => IsBohemond() && GreetingVariety.Current(16, 3) == 0, null, 200);
                starter.AddDialogLine("crus_bohemond_greeting_2", "start", "lord_start",
                    ...
                    () => IsBohemond() && GreetingVariety.Current(16, 3) == 1, null, 200);
                starter.AddDialogLine("crus_bohemond_greeting_3", "start", "lord_start",
                    ...
                    () => IsBohemond() && GreetingVariety.Current(16, 3) == 2, null, 200);
                ...
                starter.AddDialogLine("crus_baldwin2_greeting_1", "start", "lord_start",
                    ...
                    () => IsBaldwin2() && GreetingVariety.Current(17, 2) == 0, null, 200);
                starter.AddDialogLine("crus_baldwin2_greeting_2", "start", "lord_start",
                    ...
                    () => IsBaldwin2() && GreetingVariety.Current(17, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("crus_morphia_greeting_1", "start", "lord_start",
                    ...
                    () => IsMorphia() && GreetingVariety.Current(18, 2) == 0, null, 200);
                starter.AddDialogLine("crus_morphia_greeting_2", "start", "lord_start",
                    ...
                    () => IsMorphia() && GreetingVariety.Current(18, 2) == 1, null, 200);

                // TANCRED (salt 19)
                bool IsTancred() => Hero.OneToOneConversationHero != null && Hero.OneToOneConversationHero.StringId == "lord_4_16";

                starter.AddDialogLine("crus_tancred_greeting_1", "start", "lord_start",
                    ...
                    () => IsTancred() && GreetingVariety.Current(19, 2) == 0, null, 200);
                starter.AddDialogLine("crus_tancred_greeting_2", "start", "lord_start",
                    ...
                    () => IsTancred() && GreetingVariety.Current(19, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("crus_waleran_greeting_1", "start", "lord_start",
                    ...
                    () => IsWaleran() && GreetingVariety.Current(20, 2) == 0, null, 200);
                starter.AddDialogLine("crus_waleran_greeting_2", "start", "lord_start",
                    ...
                    () => IsWaleran() && GreetingVariety.Current(20, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("crus_baldwin1_greeting_1", "start", "lord_start",
                    ...
                    () => IsBaldwin1() && GreetingVariety.Current(21, 3) == 0, null, 200);
                starter.AddDialogLine("crus_baldwin1_greeting_2", "start", "lord_start",
                    ...
                    () => IsBaldwin1() && GreetingVariety.Current(21, 3) == 1, null, 200);
                starter.AddDialogLine("crus_baldwin1_greeting_3", "start", "lord_start",
                    ...
                    () => IsBaldwin1() && GreetingVariety.Current(21, 3) == 2, null, 200);
                ...
                starter.AddDialogLine("crus_joscelin_greeting_1", "start", "lord_start",
                    ...
                    () => IsJoscelin() && GreetingVariety.Current(22, 2) == 0, null, 200);
                starter.AddDialogLine("crus_joscelin_greeting_2", "start", "lord_start",
                    ...
                    () => IsJoscelin() && GreetingVariety.Current(22, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("arm_ruben1_greeting_1", "start", "lord_start",
                    ...
                    () => IsRuben1() && GreetingVariety.Current(23, 3) == 0, null, 200);
                starter.AddDialogLine("arm_ruben1_greeting_2", "start", "lord_start",
                    ...
                    () => IsRuben1() && GreetingVariety.Current(23, 3) == 1, null, 200);
                starter.AddDialogLine("arm_ruben1_greeting_3", "start", "lord_start",
                    ...
                    () => IsRuben1() && GreetingVariety.Current(23, 3) == 2, null, 200);

                // THOROS I (salt 24)
                bool IsThoros1() => Hero.OneToOneConversationHero != null && Hero.OneToOneConversationHero.StringId == "lord_5_3";

                starter.AddDialogLine("arm_thoros1_greeting_1", "start", "lord_start",
                    ...
                    () => IsThoros1() && GreetingVariety.Current(24, 2) == 0, null, 200);
                starter.AddDialogLine("arm_thoros1_greeting_2", "start", "lord_start",
                    ...
                    () => IsThoros1() && GreetingVariety.Current(24, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("arm_constantine1_greeting_1", "start", "lord_start",
                    ...
                    () => IsConstantine1() && GreetingVariety.Current(25, 2) == 0, null, 200);
                starter.AddDialogLine("arm_constantine1_greeting_2", "start", "lord_start",
                    ...
                    () => IsConstantine1() && GreetingVariety.Current(25, 2) == 1, null, 200);

                // KOGH VASIL (salt 26)
                bool IsKoghVasil() => Hero.OneToOneConversationHero != null && Hero.OneToOneConversationHero.StringId == "lord_5_14";

                starter.AddDialogLine("arm_koghvasil_greeting_1", "start", "lord_start",
                    ...
                    () => IsKoghVasil() && GreetingVariety.Current(26, 2) == 0, null, 200);
                starter.AddDialogLine("arm_koghvasil_greeting_2", "start", "lord_start",
                    ...
                    () => IsKoghVasil() && GreetingVariety.Current(26, 2) == 1, null, 200);

                // VASIL DGHA (salt 27)
                bool IsVasilDgha() => Hero.OneToOneConversationHero != null && Hero.OneToOneConversationHero.StringId == "lord_5_16";

                starter.AddDialogLine("arm_vasildgha_greeting_1", "start", "lord_start",
                    ...
                    () => IsVasilDgha() && GreetingVariety.Current(27, 2) == 0, null, 200);
                starter.AddDialogLine("arm_vasildgha_greeting_2", "start", "lord_start",
                    ...
                    () => IsVasilDgha() && GreetingVariety.Current(27, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("arm_oshinlampron_greeting_1", "start", "lord_start",
                    ...
                    () => IsOshinLampron() && GreetingVariety.Current(28, 2) == 0, null, 200);
                starter.AddDialogLine("arm_oshinlampron_greeting_2", "start", "lord_start",
                    ...
                    () => IsOshinLampron() && GreetingVariety.Current(28, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("arm_gabrielmelitene_greeting_1", "start", "lord_start",
                    ...
                    () => IsGabrielMelitene() && GreetingVariety.Current(29, 2) == 0, null, 200);
                starter.AddDialogLine("arm_gabrielmelitene_greeting_2", "start", "lord_start",
                    ...
                    () => IsGabrielMelitene() && GreetingVariety.Current(29, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("krkh_nasr_greeting_1", "start", "lord_start",
                    ...
                    () => IsNasr() && GreetingVariety.Current(30, 2) == 0, null, 200);
                starter.AddDialogLine("krkh_nasr_greeting_2", "start", "lord_start",
                    ...
                    () => IsNasr() && GreetingVariety.Current(30, 2) == 1, null, 200);

                // BUWI MARYAM (salt 31)
                bool IsBuwiMaryam() => Hero.OneToOneConversationHero != null && Hero.OneToOneConversationHero.StringId == "lord_6_4";

                starter.AddDialogLine("krkh_buwimaryam_greeting_1", "start", "lord_start",
                    ...
                    () => IsBuwiMaryam() && GreetingVariety.Current(31, 2) == 0, null, 200);
                starter.AddDialogLine("krkh_buwimaryam_greeting_2", "start", "lord_start",
                    ...
                    () => IsBuwiMaryam() && GreetingVariety.Current(31, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("krkh_bughraharun_greeting_1", "start", "lord_start",
                    ...
                    () => IsBughraHarun() && GreetingVariety.Current(32, 2) == 0, null, 200);
                starter.AddDialogLine("krkh_bughraharun_greeting_2", "start", "lord_start",
                    ...
                    () => IsBughraHarun() && GreetingVariety.Current(32, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("krkh_toghrulkhan_greeting_1", "start", "lord_start",
                    ...
                    () => IsToghrulKhan() && GreetingVariety.Current(33, 2) == 0, null, 200);
                starter.AddDialogLine("krkh_toghrulkhan_greeting_2", "start", "lord_start",
                    ...
                    () => IsToghrulKhan() && GreetingVariety.Current(33, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("krkh_hasanibnsulayman_greeting_1", "start", "lord_start",
                ...
                starter.AddDialogLine("krkh_alitegin_greeting_1", "start", "lord_start",
                    ...
                    () => IsAliTegin() && GreetingVariety.Current(34, 3) == 0, null, 200);
                starter.AddDialogLine("krkh_alitegin_greeting_2", "start", "lord_start",
                    ...
                    () => IsAliTegin() && GreetingVariety.Current(34, 3) == 1, null, 200);
                starter.AddDialogLine("krkh_alitegin_greeting_3", "start", "lord_start",
                    ...
                    () => IsAliTegin() && GreetingVariety.Current(34, 3) == 2, null, 200);
                ...
                starter.AddDialogLine("krkh_qadirkhan_greeting_1", "start", "lord_start",
                    ...
                    () => IsQadirKhan() && GreetingVariety.Current(35, 2) == 0, null, 200);
                starter.AddDialogLine("krkh_qadirkhan_greeting_2", "start", "lord_start",
                    ...
                    () => IsQadirKhan() && GreetingVariety.Current(35, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("krkh_satukbughra_greeting_1", "start", "lord_start",
                    ...
                    () => IsSatukBughra() && GreetingVariety.Current(36, 3) == 0, null, 200);
                starter.AddDialogLine("krkh_satukbughra_greeting_2", "start", "lord_start",
                    ...
                    () => IsSatukBughra() && GreetingVariety.Current(36, 3) == 1, null, 200);
                starter.AddDialogLine("krkh_satukbughra_greeting_3", "start", "lord_start",
                    ...
                    () => IsSatukBughra() && GreetingVariety.Current(36, 3) == 2, null, 200);
                ...
                starter.AddDialogLine("krkh_balasaguni_greeting_1", "start", "lord_start",
                    ...
                    () => IsBalasaguni() && GreetingVariety.Current(37, 3) == 0, null, 200);
                starter.AddDialogLine("krkh_balasaguni_greeting_2", "start", "lord_start",
                    ...
                    () => IsBalasaguni() && GreetingVariety.Current(37, 3) == 1, null, 200);
                starter.AddDialogLine("krkh_balasaguni_greeting_3", "start", "lord_start",
                    ...
                    () => IsBalasaguni() && GreetingVariety.Current(37, 3) == 2, null, 200);
                ...
                starter.AddDialogLine("lat_henryflanders_greeting_1", "start", "lord_start",
                    ...
                    () => IsHenryFlanders() && GreetingVariety.Current(38, 3) == 0, null, 200);
                starter.AddDialogLine("lat_henryflanders_greeting_2", "start", "lord_start",
                    ...
                    () => IsHenryFlanders() && GreetingVariety.Current(38, 3) == 1, null, 200);
                starter.AddDialogLine("lat_henryflanders_greeting_3", "start", "lord_start",
                    ...
                    () => IsHenryFlanders() && GreetingVariety.Current(38, 3) == 2, null, 200);
                ...
                starter.AddDialogLine("lat_marcosanudo_greeting_1", "start", "lord_start",
                    ...
                    () => IsMarcoSanudo() && GreetingVariety.Current(39, 2) == 0, null, 200);
                starter.AddDialogLine("lat_marcosanudo_greeting_2", "start", "lord_start",
                    ...
                    () => IsMarcoSanudo() && GreetingVariety.Current(39, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("byz_laskaris_greeting_1", "start", "lord_start",
                    ...
                    () => IsLaskaris() && GreetingVariety.Current(40, 2) == 0, null, 200);
                starter.AddDialogLine("byz_laskaris_greeting_2", "start", "lord_start",
                    ...
                    () => IsLaskaris() && GreetingVariety.Current(40, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("byz_kontostephanos_greeting_1", "start", "lord_start",
                    ...
                    () => IsKontostephanos() && GreetingVariety.Current(41, 2) == 0, null, 200);
                starter.AddDialogLine("byz_kontostephanos_greeting_2", "start", "lord_start",
                ...
                starter.AddDialogLine("byz_raoul_greeting_1", "start", "lord_start",
                    ...
                    () => IsRaoul() && GreetingVariety.Current(42, 2) == 0, null, 200);
                starter.AddDialogLine("byz_raoul_greeting_2", "start", "lord_start",
                    ...
                    () => IsRaoul() && GreetingVariety.Current(42, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("byz_synadenos_greeting_1", "start", "lord_start",
                    ...
                    () => IsSynadenos() && GreetingVariety.Current(43, 2) == 0, null, 200);
                starter.AddDialogLine("byz_synadenos_greeting_2", "start", "lord_start",
                    ...
                    () => IsSynadenos() && GreetingVariety.Current(43, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("byz_kamateros_greeting_1", "start", "lord_start",
                    ...
                    () => IsKamateros() && GreetingVariety.Current(44, 2) == 0, null, 200);
                starter.AddDialogLine("byz_kamateros_greeting_2", "start", "lord_start",
                    ...
                    () => IsKamateros() && GreetingVariety.Current(44, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("byz_kourtikios_greeting_1", "start", "lord_start",
                    ...
                    () => IsKourtikios() && GreetingVariety.Current(45, 2) == 0, null, 200);
                starter.AddDialogLine("byz_kourtikios_greeting_2", "start", "lord_start",
                    ...
                    () => IsKourtikios() && GreetingVariety.Current(45, 2) == 1, null, 200);
                ...
                starter.AddDialogLine("byz_melias_greeting_1", "start", "lord_start",
                    ...
                    () => IsMelias() && GreetingVariety.Current(46, 2) == 0, null, 200);
                starter.AddDialogLine("byz_melias_greeting_2", "start", "lord_start",
                    ...
                    () => IsMelias() && GreetingVariety.Current(46, 2) == 1, null, 200);
            }
            catch (Exception)
            {
                // Safety
